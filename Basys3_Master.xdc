...
set_property PACKAGE_PIN W5 [get_ports {sys_clk_pin}]                                                    
        ...
        create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {sys_clk_pin}]
...
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {DIN}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {DIN}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {PWM_PIN}]                                       
...
set_property PACKAGE_PIN A15 [get_ports {cs_n}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {cs_n}]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {DIN}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {DIN}]
#Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {DOUT}]                                       
